...
source: https://tiendanube.github.io/api-documentation/resources/abandoned-checkout
version: 2025-03
---
...
While it is not possible to fetch abandoned checkouts from over 30 days ago, it is still possible for an old abandoned checkout to be converted into an Order.
Abandoned checkouts are completely deleted after 90 days.
...
> [Create a discount coupon](#post-checkoutscart_idcoupon)
...
| product_id | Integer | [Product](/api-documentation/resources/product) purchased. 
...
| variant_id | Integer | [Product Variant](/api-documentation/resources/product-variant) purchased. 
...
| `coupon_id` | ID of the [Coupon](/api-documentation/resources/coupon) that applies to this abandoned cart. | Integer | Yes 
