...
export const DEFAULT_ADS_QUIZ_CONFIG: AdsQuizConfig = {
  ...
  landing: {
    ...
    subheadline:
      "Responda em poucos minutos. A cada resposta, mostramos como o método — calls, networking e suporte próximo — se encaixa no seu momento. Você também recebe loja online pronta, com produtos validados por nicho, logo, banner e identidade visual. Sem cartão.",
