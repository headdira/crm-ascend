-- Funil Ascend inspirado InLead: dor → mecanismo → diagnóstico
...
VALUES (
  ...
  "landing": {
    ...
    "subheadline": "Responda em poucos minutos. A cada resposta, mostramos como o método — calls, networking e suporte próximo — se encaixa no seu momento. Sem cartão.",
