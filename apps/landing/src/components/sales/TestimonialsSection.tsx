...
export default function TestimonialsSection() {
  return (
    <section id="depoimentos" className="bg-[#0d0d0d] py-24 px-6">
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <blockquote className="flex-1 border-l-[3px] border-primary pl-5 pr-2">
                <p className="font-inter text-white/85 text-base sm:text-lg leading-relaxed">
                  &ldquo;{t.text}&rdquo;
                </p>
              </blockquote>
