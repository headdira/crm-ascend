...
export default function PricingCTA() {
  return (
    <section id="preco" className={brandSurfaces.deep}>
      <Ticker text="GARANTA SUA VAGA · VAGAS LIMITADAS" bgColor="bg-primary" textColor="text-black" />
      <div className="py-24 px-6 max-w-4xl mx-auto">
        <motion.div
          className={`relative rounded-3xl overflow-hidden border border-primary/20 ${brandSurfaces.elevated}`}
        ...
        >
          ...
          <div className="relative z-10 p-8 sm:p-12 md:p-16">
            ...
            <div className="text-center mb-10">
              ...
              <p className={`max-w-xl mx-auto ${brandTypography.body}`}>
